...
//     const router = useRouter();
//   return (
//     <Card onClick={()=>router.push(`/movies/${id}`)} 
//     className="relative w-[160px] sm:w-[180px] md:w-[200px] h-[300px] flex flex-col overflow-hidden rounded-xl shadow-md hover:scale-105 transition-transform cursor-pointer bg-gray-900"
//     // className="relative min-w-[160px] h-[260px] overflow-hidden rounded-xl shadow-md hover:scale-105 transition-transform cursor-pointer"
//     >
//       {/* Poster */}
