...
export default function WatchlistPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 bg-black text-white">
      <h1 className="text-3xl md:text-4xl font-bold mb-6">My Watchlist</h1>

      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
        {watchlistMovies.map((movie) => (
          <div
            key={movie.id}
            className="bg-gray-900 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition cursor-pointer"
          >
            <img
            ...
            <div className="p-3 md:p-4 flex flex-col gap-1 md:gap-2">
              ...
              <Button
                ...
                className="mt-1 md:mt-2 px-3 py-1 md:px-4 md:py-2 rounded-full bg-red-600 hover:bg-red-700 text-white font-semibold text-xs md:text-sm"
              >
                Remove
              </Button>
            </div>
